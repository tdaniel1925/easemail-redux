...
- `layout-marketing-site.md` — Landing pages, pricing, blog, SEO, conversion optimization. Use for any public-facing marketing pages.
...
- `infra-realtime-advanced.md` — Advanced real-time: presence tracking, broadcast, typing indicators, collaborative features.
- `infra-multi-step-form.md` — Wizard: step progress, per-step validation, draft save, navigation.
- `infra-multi-tenant.md` — Multi-tenant SaaS: org isolation, RLS, org switching, invites, plan-based feature gating.
- `infra-background-jobs.md` — Job queues (Inngest/BullMQ): bulk operations, scheduled tasks, cron, retries.
- `infra-e2e-testing.md` — Playwright E2E tests: auto-generated from Gate 2 workflows, auth tests, CRUD tests.
